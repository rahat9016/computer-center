    ...
    <div className="container">
      ...
      <div className="collapse navbar-collapse  " id="navbarSupportedContent">
        <ul className="navbar-nav mb-2 mb-lg-0 ms-auto">
          ...
          <li className="nav-item">
            <Link className="nav-link text-white me-5">About us</Link>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <Link className="nav-link text-white me-5" to="/admin">Admin</Link>
          </li>
          <li className="nav-item"> 
          {
            loggedInUser.email ? <p>{loggedInUser.displayName}</p> :<Link className="nav-link text-white brand-btn px-3 py-2" to="/login">Login</Link> 
          }
